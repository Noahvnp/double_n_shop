...
<?php
	...
	class product
	{
		...
		public function getSmartPhone(){
			$query = "SELECT * FROM tbl_product WHERE catId = '5' order by productId desc LIMIT 8";
			$result = $this->db->select($query);
			return $result;
		}
		public function getLaptop(){
			$query = "SELECT * FROM tbl_product WHERE catId = '3' order by productId desc LIMIT 8";
			$result = $this->db->select($query);
			return $result;
		}
		public function getAccessories(){
			$query = "SELECT * FROM tbl_product WHERE catId = '6' order by productId desc LIMIT 8";
			$result = $this->db->select($query);
			return $result;
		}
		public function getSpeaker(){
			$query = "SELECT * FROM tbl_product WHERE catId = '18' order by productId desc LIMIT 8";
			$result = $this->db->select($query);
			return $result;
		}
	}
